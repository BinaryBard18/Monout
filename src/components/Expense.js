...
export default function Expense(){
    ...
    //             const start = dayjs(item.startDate, "MMMM DD, YYYY");
    //             const reset = dayjs(item.resetDate, "MMMM DD, YYYY");
    //             setStartDate(start);
    //             setEndDate(reset);
    //         }
    //     } catch (error) {
    //         console.log("Dates not found : ", error);
    //     }
    // }
    ...
    function handleDateChange(newDate) {
        if (!newDate) {
            ...
            setExpense(prev => ({ ...prev, dateOfTransaction: newDate.toDate() }));
            setShowDateWarn(false);
        }
    }
